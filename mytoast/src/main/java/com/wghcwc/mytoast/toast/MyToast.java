package com.wghcwc.mytoast.toast;
...
import com.wghcwc.mytoast.toast.style.ToastBlackStyle;
...
public final class MyToast {
    ...
    /**
     * 检查吐司状态，如果未初始化请先调用{@link MyToast#init(Application)}
     */
    private static void checkToastState() {
        // 吐司工具类还没有被初始化，必须要先调用init方法进行初始化
        if (sToast == null) {
            throw new IllegalStateException("MyToast has not been initialized");
        }
    }
